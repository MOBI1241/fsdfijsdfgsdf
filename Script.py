...
אני בוט סרטים וסדרות חדשני, התפקיד שלי זה לעשות לכם חיים קלים תוסיפו אותי לקבוצה שלכם שלכם ואני המשיך מכאן

‣ מתכנת ראשי : <a href='https://t.me/Yishaicohen'>ישי</a></b>
"""

    GSTART_TXT = """<b>שלום {},\n\nבוט סרטים חדשני עם תכונות מעניינות הבוט נועד לעזור לקבוצות.\n\nמתכנת ראשי : <a href="https://t.me/Yishaicohen">ישי</a></b>"""

    HELP_TXT = """<b>קראו קצת עלינו בשביל לתת לכם תשובות לשאלות שלכם!</b>"""
 
    ABOUT_TXT = """
<b>❍ בעל הבוט : <a href="https://t.me/The_media_eagle_bot">לפרסום או לקנות פרמיום פנו אליי</a>
❍ מתכנת ראשי : <a href="https://t.me/Yishaicohen">ישי</a>
❍ ספריה : <a href="https://pyrogram.org/">ᴘʏʀᴏɢʀᴀᴍ</a>
❍ שפה : <a href="https://www.python.org/">ᴘʏᴛʜᴏɴ</a>
❍ מאגר מידע בתשלום בלבד! : <a href="https://t.me/The_media_eagle_bot">לפרטים פנו אליי</a>
❍ אירוח ב : <a href="https://t.me/codeflix_bots">ᴠᴘs</a>
❍ מערכת בסיסית : ᴠ4.3.1 [ᴀᴅᴠᴀɴᴄᴇ ғᴇᴀᴛᴜʀᴇs]

➲  אני יכול להגביל משתמשים.
➲  יש לי מערכת מאוד חדשנית ומיוחדת.
➲  אני יכול לספק סרטים באיכות מטורפת.
➲  אני יכול להעיף אנשים בקבצות.
➲  יש לי הרבה תכונות מיוחדות בבוט עצמו תבדקו בפקודת /commands.

➻ תלחצו על הכפתור קצת עלינו יתן לכם עזרה בסיסית להבין איך להשתמש בבוט.</b>"""
                  
    DISCLAIMER_TXT =  """<b>זה לא קוד מקור פתוח.

.

מתכנת ראשי : <a href="https://t.me/Yishaicohen">ישי</a></b>"""

    DONATE = """<b>💵 אני מבקש ממך 💸

בבקשה תתרום לנו כסף על מנת שנוכל לתחזק את הבוט ולספק ת השירות הנהדר הזה.</b>

כל סכום יתקבל בברכה 💷

<b>᚜ דרכי תשלום ᚛</b>

➢ <a href='https://graph.org/file/02e7ecc3e2693b481b914.jpg'>ביטקוין</a>

דבר איתי כדי לדעת את פרטי התשלום

<b>לחץ כאן - <a href='https://telegram.me/veldxd'>בעלים</a>
לחץ כאן - <a href='https://telegram.me/sewxiy'>מנהל ראשי</a>
לחץ כאן - <a href='https://telegram.me/mikey_0x'>מתכנת ראשי</a></b>"""

    SUBSCRIPTION_TXT = """
<b>בבקשה שתף את הבוט שלנו יעזור לנו מאוד {}

לינק הזמנה לבוט - https://telegram.me/{}?start=Lucy-{}

אם {} נוכל לספק לך פרמיום בהמשך הדרך.

תוכנית פרמיום- /plan</b>"""
...
<b>• {file_name}
╭──────────────────╮
• <a href="https://t.me/Movietext83">ערוץ עדכונים</a>
• <a href="https://t.me/media_box_il">קבוצת תמיכה</a>
• <a href="https://t.me/il_333">ערוץ סרטים</a>
╰──────────────────╯

• מופעל על ידי : <a href="https://t.me/Movietext83">בוט סרטים</a></b>"""
...
‣ שפה : <code>{languages}</code></a>
‣ זמן : {runtime} Minutes</a>

‣ תקציר : <b>{plot}</b> 

<b>‣ בקשה מאת: {message.from_user.mention}</b>"""

    
    ALL_FILTERS = """
<b>היי {}, 3 סוגים של מסננים.</b>"""
    
    GFILTER_TXT = """Hᴇʟᴘ : <b>Gʟᴏʙᴀʟ Fɪʟᴛᴇʀs</b>
    
◈ גלובל פיטלר יעבוד בכל הקבוצות.
    
<b>פקודות והסבר שימוש :</b>
• /gfilter - ליצור פיטלר גלובלי.
• /gfilters - לראות את כל פלטר גלובלי.
• /delg - למחוק פילטר גלובלי.
• /delallg - למחוק את כל הפילטר גלובלי."""
